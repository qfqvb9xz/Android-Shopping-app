...
import com.example.lzy3qy.shopping.data.ProdlistDbHelper;
import com.example.lzy3qy.shopping.data.ProductListContract;
import com.example.lzy3qy.shopping.databinding.ActivityChildBinding;
...
public class ChildActivity extends AppCompatActivity {
    ...
    public long AddCart(String productId, String productNum, String detailPage) {
        //do something for cart!
        ContentValues cv = new ContentValues();
        cv.put(ProductListContract.ProdlistEntry.COLUMN_PRODUCT_NAME, productId);
        cv.put(ProductListContract.ProdlistEntry.COLUMN_PRODUCT_NUMBER, Character.getNumericValue(productNum.charAt(10)));
        cv.put(ProductListContract.ProdlistEntry.COLUMN_URL, detailPage);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBinding.fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AddCart(mBinding.PNAME.getText().toString(),mBinding.planetsSpinner.getSelectedItem().toString(), detailPage);
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_cart) {
            startActivity(new Intent(ChildActivity.this, CartActivity.class));
            return true;
        }
